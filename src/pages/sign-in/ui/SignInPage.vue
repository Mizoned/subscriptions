...
<template>
  <div class="bg-surface-50 dark:bg-surface-950 flex justify-content-center min-h-screen min-w-100vw overflow-hidden">
    <div class="flex justify-content-center align-items-center">
      <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
        <div class="form w-full p-7" style="border-radius: 53px">
          ...
          <div>
            ...
            <div class="flex flex-column align-items-center justify-content-center">
              <span class="text-800 font-medium mb-2">У вас ещё нет аккаунта?</span>
